...
class Smart_Manager_Admin_Welcome {
	...
	function smart_manager_support_ticket_content() {
		...
		StoreApps_Upgrade_3_7::support_ticket_content( self::$prefix, self::$sku, $plugin_data, $license_key, 'smart-manager-for-wp-e-commerce' );
	}
	...
	private function intro() {
		...
		<div style="margin-top:0.3em;"><?php _e( "Glad to have you onboard. We hope Smart Manager adds to your desired success 🏆 </br>Registered by hottheme.net", 'smart-manager-for-wp-e-commerce' ); ?></div>
