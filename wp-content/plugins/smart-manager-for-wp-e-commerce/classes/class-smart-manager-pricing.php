	...
	public static function sm_show_pricing() {
		...
		<div class="wrap about-wrap sm">
			<div class="sm_row" id="sm-pricing">
				<div class="sm_main_heading"><?php echo sprintf( __( '🎉 Congratulations! You just unlocked %s on Smart Manager Pro 🎉 ', 'smart-manager-for-wp-e-commerce' ), '<span class="sm_discount_code">' . __( '25% Off', 'smart-manager-for-wp-e-commerce' ) . '</span>' ); ?></div>
				<div class="sm_price_column_container">
					...
					<div class="sm_column column_one_fourth pricing sm_lifetime_price scaleup" style="border-color: #252f3fe6;padding: 0;border-width: 0.2em;">
						...
						<span class="sm_price">
							...
							<h2><?php echo __( '$337', 'smart-manager-for-wp-e-commerce' ); ?></h2>
						</span>
					...
					<div class="sm_column column_one_fourth pricing sm_last sm_lifetime_price">
						...
						<span class="sm_price">
							...
							<h2><?php echo __( '$360', 'smart-manager-for-wp-e-commerce' ); ?></h2>
						</span>
